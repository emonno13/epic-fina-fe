...
export const ACHIEVEMENTS = [
  {
    icon: <FavoriteChartIconSvg />,
    value: '98,1%',
    description: 'Tỷ lệ hồ sơ giải ngân thành công',
  },
  {
    icon: <UserSquareIconSvg />,
    value: '+10.000',
    description: 'Khách hàng sử dụng nền tảng dịch vụ',
  },
  {
    icon: <ClipboardTextIconSvg />,
    value: '+5000',
    description: 'Hồ sơ vay được thẩm định',
  },
  {
    icon: <DollarSquareIconSvg />,
    value: '+5.000 tỷ',
...
export const REASONS_CHOOSE_FINA = [
  {
    icon: <TimeFillIconSvg />,
    value: 'Tiết kiệm thời gian',
    description:
      'FINA chủ động tìm kiếm, so sánh và lựa chọn giải pháp tài chính tốt nhất.',
  },
  {
    icon: <SearchFillIconSvg />,
    value: 'Đa dạng lựa chọn',
    description:
      'FINA mang đến hàng loạt lựa chọn về giải pháp tài chính mà không thuộc sở hữu của bất kỳ tổ chức nào.',
  },
  {
    icon: <TicketFillIconSvg />,
    value: 'Lãi suất ưu đãi',
    description:
      'Tiếp cận được những khoản vay với lãi suất cạnh tranh thấp hơn thị trường từ phía ngân hàng.',
  },
  {
    icon: <CheckFillIconSvg />,
    value: 'Hoàn toàn miễn phí',
    description:
      'FINA tư vấn và hỗ trợ khách hàng cho đến khi hoàn tất quy trình vay vốn, với mức phí là 0đ.',
  },
];
