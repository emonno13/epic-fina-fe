...
const SeoTags = (props: SeoTagsProps) => {
  ...
  return (
    <Head>
      ...
      {title && (
        <meta name="title" content={title} key={SeoTagsKey.META_TITLE} />
      )}
      {description && (
        <meta
          name="description"
          content={description}
          key={SeoTagsKey.META_DESCRIPTION}
        />
      )}
      ...
      {title && (
        <meta
          property="og:title"
          content={title}
          key={SeoTagsKey.META_OG_TITLE}
        />
      )}
      {url && (
        <meta property="og:url" content={url} key={SeoTagsKey.META_OG_URL} />
      )}
      {thumbUrl && (
        <meta
          property="og:image"
          content={thumbUrl}
          key={SeoTagsKey.META_OG_IMAGE}
        />
      )}
      {thumbUrl && (
        <meta
          property="og:image:width"
          content={imageWidth || '1080'}
          key={SeoTagsKey.META_OG_IMAGE_WIDTH}
        />
      )}
      {thumbUrl && (
        <meta
          ...
          key={SeoTagsKey.META_OG_IMAGE_HEIGHT}
        />
      )}
      {description && (
        <meta
          ...
          content={description}
          key={SeoTagsKey.META_OG_DESCRIPTION}
        />
      )}
      {type && (
        <meta property="og:type" content={type} key={SeoTagsKey.META_OG_TYPE} />
      )}
      <meta property="og:locale" content="vi" key={SeoTagsKey.META_OG_LOCALE} />
      <meta
        property="og:site_name"
        content="FINA"
        key={SeoTagsKey.META_OG_SITENAME}
      />
      ...
      {thumbUrl && (
        <meta
          name="facebook:image"
          content={thumbUrl}
          key={SeoTagsKey.META_FACEBOOK_IMAGE}
        />
      )}
