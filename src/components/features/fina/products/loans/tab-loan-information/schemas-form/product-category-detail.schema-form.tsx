...
import {
  PropertyInformation,
  VehicleInformation,
} from '../../product-component-common/product-category';
...
export const ProductCategoryDetail = (
  ...
  switch (typeCategory) {
    case PRODUCT_CATEGORIES[PRODUCT_TYPES.loan].vehicle:
      return [...dynamicSchema, ...VehicleInformationSchemaItem(props)];
    case PRODUCT_CATEGORIES[PRODUCT_TYPES.loan].real_estate:
      return [...dynamicSchema, ...ReInformationSchemaItem(props)];
    default:
      return [...dynamicSchema, ...ReInformationSchemaItem(props)];
  }
};

export const ReInformationSchemaItem = (
  props: HFormProps,
): HFormItemProps[] => {
  return [
    createSchemaItem({
...
export const VehicleInformationSchemaItem = (
  props: HFormProps,
): HFormItemProps[] => {
  return [
    createSchemaItem({
