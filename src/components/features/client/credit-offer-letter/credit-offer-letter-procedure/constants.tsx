...
export const getCreditOfferLetterProcedureGenerateArray =
  (): CreditOfferLetterProcedureItemProps[] => {
    return [
      {
        step: 1,
...
export const WORKING_PROCESS = [
  { title: 'Khách hàng', content: '', icon: <ClientIcon /> },
  {
    ...
    content: 'Gửi thông tin về yêu cầu của khách hàng',
    icon: <ConsultationRequestIcon />,
  },
  {
    title: 'Tiếp nhận',
    content: 'Thực hiện liên hệ sớm trong vòng 5-10p',
    icon: <ReceiveIcon />,
  },
  {
    title: 'Thực hiện cuộc gọi',
    content:
      'Đưa ra giá trị khách hàng sẽ nhận được và thu thập thông tin đầy đủ',
    icon: <MakeCallIcon />,
  },
  {
    title: 'Gửi thư chào tín dụng',
    content:
      'Nhân viên tư vấn của FINA sẽ gửi bản thư chào tín dụng cho khách hàng',
    icon: <SendLetterCreditSvg />,
  },
  {
    title: 'Banker tiếp nhận yêu cầu',
    content:
      'Banker thực hiện kiểm tra thông tin khách hàng và phản hồi lại cho FINA',
    icon: <BankerReceivesRequestIcon />,
  },
  {
    title: 'Tư vấn khách hàng chọn bank',
    content: 'Tư vấn khách hàng lựa chọn các ngân hàng đã tiếp nhận',
    icon: <CustomerConsultingChooseBankIcon />,
  },
  {
    title: 'Tạo hồ sơ vay',
    content: 'Tạo và theo dõi quy trình xử lý hồ sơ vay tại ngân hàng',
    icon: <CreateLoanApplicationIcon />,
  },
  {
    title: 'Thông báo kết Quả',
    content: 'Gửi thư chúc mừng khách hàng được duyệt và giải ngân thành công',
    icon: <ResultAnnouncementIcon />,
  },
];
