...
import ItemRowView from '../../bond-loan-item/bond-loan-item.item-row-view';

const ClientLoanListMainListItemService = ({ label, value, unit }) => (
  <div className="client-loan-list-main-list-item-list-view__content__service__item">
    <div className="client-loan-list-main-list-item-list-view__content__service__item__label">
      {label}
    </div>
    <div className="client-loan-list-main-list-item-list-view__content__service__item__value">
      {value}
    </div>
    <div className="client-loan-list-main-list-item-list-view__content__service__item__unit">
      {unit}
    </div>
  </div>
);

const ClientLoanListMainListItemListView = ({ loanData, onClick }) => {
  const {
    name,
  ...
  const content = (
    <div className="client-loan-list-main-list-item-list-view__content__service">
  ...
  const uiDescription = (
    <div className="client-loan-list-main-list-item-list-view__info-wrap__left__advantage-wrap">
      {outstandingAdvantages && (
...
export default ClientLoanListMainListItemListView;
